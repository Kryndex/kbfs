...
func (md *RootMetadata) CheckValidSuccessor(
	currID kbfsmd.ID, nextMd *RootMetadata) error {
	err := md.bareMd.CheckValidSuccessor(currID, nextMd.bareMd)
	switch errors.Cause(err).(type) {
	case kbfsmd.MetadataIsFinalError:
		err = MetadataIsFinalError{}
	}
	return err
}
...
func (md ReadOnlyRootMetadata) CheckValidSuccessor(
	...
	return md.RootMetadata.CheckValidSuccessor(currID, nextMd.RootMetadata)
}
